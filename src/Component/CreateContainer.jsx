...
const CreateContainer = () => {
  ...
  const uploadImage = (e) => {
    ...
    //kanha upload karna hai firebase storage me jo firebase.config se access ho rha , hamne firebase storage me Image folder banaya hai
  ...
  const clearData = () => {
    //after clicking save it will empty all the fields , call it above
    setTitle("");
    setImageAsset(null);
    setCalories("");
    setPrice("");
  ...
  const fetchData = async () => {
    await getAllFoodItems().then((data) =>{     // when ever we save the data it is going to update it in stateProvider so that we can 
      dispatch({                                 //easily access that anywhere
