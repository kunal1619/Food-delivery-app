  ...
  return (
    <section className='grid grid-cols-1 md:grid-cols-2 gap-2 w-full' id='home'>
      ...
      <div className='py-2 flex-1 flex flex-col items-start justify-center gap-6'>
        ...
        <p className='text-[2.5rem] font-bold tracking-wide text-headingColor lg:text-[4.5rem]'>The Fastest Delivery in
        <span className='text-orange-600 text-[3rem] lg:text-[5rem]'>Your City</span></p>

        <p className='text-base text-textColor text-center md:text-left md:w-[80%]'>
          Lorem, ipsum dolor sit amet consectetur adipisicing elit. Alias quia beatae fugiat veritatis ex odio accusamus minima blanditiis ducimus, amet, saepe quae dolore. Nihil cupiditate quidem perspiciatis asperiores ut ipsam.
        </p>
      ...
      <div className="py-2 flex-1 flex items-center relative">
        ...
        {heroData && heroData.map(n => (
            <div key={n.id} className='lg:w-190 p-4 bg-cardOverlay backdrop-blur-md rounded-3xl flex flex-col items-center justify-center drop-shadow-lg'>
                <img src={n.imageSrc} className="w-20 lg:w-40 -mt-10 lg:-mt-20" alt="Items" />
